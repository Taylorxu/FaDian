...
import com.powerge.wise.powerge.operationProjo.net.bean.UserBean2;
...
public class WOSUAdapter extends RecyclerView.Adapter {
    private Context context;
    private List<UserBean2> datas;
    private IMultUserClickListener listener;

    public WOSUAdapter(Context context, List<UserBean2> datas) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof MyHolder) {
            final UserBean2 bean = datas.get(position);
