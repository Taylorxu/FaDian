...
public class CheckBoxViewAdapter extends RecyclerView.Adapter {
    ...
    public CheckBoxViewAdapter(Context context, List<QueryAllValidDictDateResponse.ReturnValueBean.DictDatasBean> list) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof MyHolder) {
            final QueryAllValidDictDateResponse.ReturnValueBean.DictDatasBean str = list.get(position);
