...
public class SelectAccountAdapter3 extends RecyclerView.Adapter {
    private Context context;
    private List<Map<String, String>> datas;
    private IContractInfo iContractInfo;

    public SelectAccountAdapter3(Context context, List<Map<String, String>> datas) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof MyHolder) {
            ...
            String key = ((SelectAccountActivity3)context).getKey();
