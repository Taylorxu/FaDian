...
public class MultUserChooseViewAdapter extends RecyclerView.Adapter {
    ...
    private List<QueryValidUsersByIdsResponse.ReturnValueBean> datas;
    private IMultUserChoose iMultUserChoose;
    private int TYPE0=0;
    private int TYPE1=1;
    public MultUserChooseViewAdapter(Context context,List<QueryValidUsersByIdsResponse.ReturnValueBean> datas){
    ...
    public interface IMultUserChoose{
        void setOnIMultUserChoose(QueryValidUsersByIdsResponse.ReturnValueBean bean);
        void setOnAddUser();
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof MyHolder){
            final QueryValidUsersByIdsResponse.ReturnValueBean bean = datas.get(position);
