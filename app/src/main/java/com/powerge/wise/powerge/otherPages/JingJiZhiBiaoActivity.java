...
// 关键代码
    ...
    public void crossfade() {
        binding.llLayoutContent.setAlpha(0f);
        binding.llLayoutContent.setVisibility(View.VISIBLE);
        binding.llLayoutContent.animate().alpha(1f)
                .setDuration(1000);
        binding.flLayoutProgress.animate().alpha(0f)
                .setDuration(1000)
                .setListener(new AnimatorListenerAdapter() {
                    @Override
                    public void onAnimationEnd(Animator animation) {
                        binding.flLayoutProgress.setVisibility(View.GONE);
                    }
                });
    }
