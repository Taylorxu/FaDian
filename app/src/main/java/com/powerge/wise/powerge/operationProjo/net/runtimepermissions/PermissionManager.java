...
public class PermissionManager {
    ...
    private PermissionService mService;
    private PermissionOption mOptions;
    ...
    PermissionManager(Context context) {
        mContext = context;
        mService = new PermissionService();
     ...
     * @param acpListener
     */
    synchronized void request(PermissionOption options, PermissionListener acpListener) {
    ...
    private void startSetting() {
        if (PermissionCheck.isMIUI()) {
            Intent intent = PermissionCheck.getSettingIntent(mActivity);
            if (PermissionCheck.isIntentAvailable(mActivity, intent)) {
