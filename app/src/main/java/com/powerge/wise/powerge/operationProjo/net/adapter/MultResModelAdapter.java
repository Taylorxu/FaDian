...
public class MultResModelAdapter extends RecyclerView.Adapter {
    private Context context;
    private List<QueryAllValidUsersResponse.ReturnValueBean> datas;
    private IMultUserClickListener listener;
    private List<QueryAllValidUsersResponse.ReturnValueBean> returnDatas = new ArrayList<>();

    public MultResModelAdapter(Context context, List<QueryAllValidUsersResponse.ReturnValueBean> datas) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof MyHolder) {
            final QueryAllValidUsersResponse.ReturnValueBean bean = datas.get(position);
