...
import com.powerge.wise.powerge.databinding.FragmentIssuseWorkingBinding;
 ...
 */
public class IssuseWorkingFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, RefreshRecyclerView.OnLoadMoreListener, SeachView.ISearchView {
    FragmentIssuseWorkingBinding binding;

    public static IssuseWorkingFragment newInstance() {
        IssuseWorkingFragment fragment = new IssuseWorkingFragment();
        return fragment;
    }

    public IssuseWorkingFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(LayoutInflater.from(getContext()), R.layout.fragment_issuse_working, container, false);
        init();
