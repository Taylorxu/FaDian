...
public class SheBeiRootBean extends RootBean {
    ...
    public List<SheBeiRootBean> getDeadData() {
        ...
        List<SheBeiRootBean> sheBeiRootBeans = new ArrayList<>();
        Gson g = new Gson();
        sheBeiRootBeans = g.fromJson(result, new TypeToken<List<SheBeiRootBean>>() {
        }.getType());
