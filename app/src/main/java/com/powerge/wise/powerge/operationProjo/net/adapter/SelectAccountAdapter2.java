...
public class SelectAccountAdapter2 extends RecyclerView.Adapter {
    private Context context;
    private List<Map<String, String>> datas;
    private IContractInfo iContractInfo;

    public SelectAccountAdapter2(Context context, List<Map<String, String>> datas) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof MyHolder) {
            ...
            String key = ((SelectAccountActivity2) context).getKey();
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (((MyHolder) holder).iv_mult_account.isSelected()) {
                        datas.get(position).put("isSelect", "true");
                    } else {
                        datas.get(position).put("isSelect", "false");
                    }
