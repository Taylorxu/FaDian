...
public class CreateProcessByTemplateResponse extends BaseResponse {
    ...
    public static class ResultBean {
         ...
         * KNO_AN :
         * SR_RJSJF :
         * IS_WHA : is_wota:26c3a2ab-15da-4c1f-be66-87a9c2104699
         * SE_THING :
         * SR_NUMB_JJ :
         * PRO_DEAL_ATTACHMENT :
         * SE_CUSTOMER :
         * IS_WT : is_wt:f8bb2aeb-d753-48c1-bceb-be1bdf89ef33
         * RELEATED_WORKORDERS :
         * KNO_MAN_SUB_TIME : 2017-01-13 13:47:07
         * SR_DLAACS :
         * SR_PAP :
         * IS_TJZSZJ : tjzszj:a337c997-1659-4e2c-a7bb-231f5f7c5d4f
         * PRO_REVIEW_COMMENTS :
         * IS_FAO :
         * SR_RJTZF :
         * SR_CP :
         * IS_BXBJ :
         * SE_SUPPORT : sure:a58f9088-f3b0-46b8-8f76-4aa047257261
         * SE_PJ :
         * PRO_CAUSES :
         * IS_KCPD :
         * PRO_ADJUNT :
         ...
         * KNO_NUM :
         * SR_SJQYF :
         * PROCESS_STATE : PRO_STA:44f0b7b9-5a14-414e-b354-44c73f2a1854
         * IS_DIS :
         * SE_CUSTOMERMUMBER :
         * KNO_COM_PER : 2967e352-8749-4c3a-b377-008ae1f0395d
         * SR_NUMB_HH :
         * SE_COME :
         * KNO_MAN_REL_TIME :
         * TPMEN :
         ...
         * SR_IB :
         * KNO_ZJJJGC :
         * KNO_OPE : KNO_OPE:63058cc3-1769-4714-8023-fc334130b962
         * IS_JSFX :
         * SR_NUMB_FF :
         * SR_ERXIAN :
         * PRO_SFTG :
         ...
         * TITLE : ghjhh
         * SR_JSJLF :
         * IS_PS : is_ps:7f864cb8-de68-419a-921b-4d4e5c392e9b
         * SR_TRIR :
         * APP_TIME :
         * SR_BGCLR :
         * SR_CLRA :
         * SR_PMAN :
         * KNO_TYPE : mt:fdc2525c-a7be-4127-ac2a-8b95289f14c2
         * SR_FWDD :
         * IS_FEOTC :
         * SR_NUMB_B :
         * PRO_VER :
         ...
         * SR_STYP :
         * LIN_EVE_NUM :
         * specificValueUpdate : {"values":[{"formItemValue":{"value":"currentTime","name":"当前时间"},"formItem":{"columnsJson":null,"id":"datadisplaydate_1","nodeType":"DataDisplayDate","dmAttrDisplayName":"知识管理提交时间","isCanAdd":true,"precision":null,"isCanUpdate":true,"seeHisWorkOrderInfo":true,"isCanDelete":true,"ID":"datadisplaydate_1","configModifiedField":null,"bmModelName":"KNO","name":"知识管理提交时间","value_label":null,"isVisible":true,"value":"","modified":false,"modelName":"KNO","sectionId":"Section0","srclib":"","required":false,"isExecute":false,"dmAttrName":"KNO_MAN_SUB_TIME","maxChars":null,"dataProvider":null,"srclib_label":null}},{"formItemValue":{"value":"KNO_S:20a05e98-dcdd-4713-8cf9-7fb577e9376b","name":"新提交"},"formItem":{"columnsJson":null,"id":"combobox_2","nodeType":"ComboBox","dmAttrDisplayName":"流程状态","isCanAdd":true,"precision":null,"isCanUpdate":true,"seeHisWorkOrderInfo":false,"isCanDelete":true,"ID":"combobox_2","configModifiedField":null,"bmModelName":"KNO","name":"流程状态","value_label":"\"null\"","isVisible":false,"value":"","modified":false,"modelName":"KNO","sectionId":"Section0","srclib":"KNO_S","dataProvider":null,"isExecute":false,"dmAttrName":"PROCESS_STATE","maxChars":null,"required":false,"srclib_label":"知识管理流程"}}]}
         * PRO_ANALYZE :
         * KNO_MAN_REL_PER :
         * SR_QTFWF :
         * SR_PJAZ :
         * taskStrategy : {"strategyKey":"assignee","strategyValue":"bd93c152-a32b-400e-af8b-fd26b26ac752,c5b8bbd9-d2ed-457b-be86-dbaf88d778b7"}
         * IS_EOTC :
         * SR_BGFL :
         * IS_AO :
         * IS_PJCS :
         ...
         * SR_NUMB_D :
         * SR_RJSJ :
         * CREATEDATE : 2017-01-13 13:46:44
         * SR_IP :
         * IS_PRONA :
         * PRO_DEBUGER :
         * PRO_INVESTIGATE :
         ...
         * SR_SRTABLE :
         * PRO_CLT :
         * IS_EI : is_pi:405d9b4a-f22c-437a-bdc1-9160028d71ec
         * IS_CLSJB :
         * IS_CLSJA :
         * SR_JSSJ :
         * IS_ZJPZ :
         ...
         * CHE_PER :
         * IS_BU :
         * SE_PERFEVT : perfect:27601f60-f5be-4f4f-b9d7-6088cf17b9e0
         * IS_DIS_D :
         * IS_DIS_E :
         * SR_NO :
         * IS_DIS_B :
         ...
         * IS_DIS_M :
         * IS_DIS_L :
         * IS_DL : is_dl:2fe17df5-7e67-44c0-85a4-d434425ebd94
         * IS_ZSKJL :
         * IS_DIS_G :
         * IS_DIS_I :
         * SR_SECSP :
         ...
         * SR_QUYU :
         * PROCESS_KEY : PROTEST
         * currentAssignee : 2967e352-8749-4c3a-b377-008ae1f0395d
         */
