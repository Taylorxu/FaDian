...
import com.wisesignsoft.OperationManagement.bean.LinkBean;
...
import com.wisesignsoft.OperationManagement.net.request.RequestBusiness;
...
//                iSetDataById.setLink();
    ...
    private void setLoad3(final List<ImageItem> list, final LoadListener1 loadListener) {
        if (list.size() > 0 && position < list.size()) {
            ...
            list1.add(MySharedpreferences.getUser().getUsername());
