...
package com.wisesignsoft.OperationManagement.view.widget;
...
import com.wisesignsoft.OperationManagement.view.widget.adapters.WheelViewAdapter;
...
//			0x00AAAAAA, 0x00AAAAAA };
	...
	// Wheel drawables
	private int wheelBackground = R.mipmap.home;
	private int wheelForeground = R.mipmap.home;
...
//		setBackgroundResource(wheelBackground);
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.home_line));
		// 设置线宽
