...
public class MultRoleAdapter extends RecyclerView.Adapter {
    ...
    private List<FindRoleByGroupIdResponse.ReturnValueBean> returnDatas = new ArrayList<>();

    public MultRoleAdapter(Context context, List<FindRoleByGroupIdResponse.ReturnValueBean> datas) {
