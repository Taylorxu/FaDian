...
public class NewWorkOrderAdapter extends RecyclerView.Adapter {
    ...
    public NewWorkOrderAdapter(Context context, List<FindCanCreateProcessResponse.ResultBean> datas) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof MyHolder) {
            FindCanCreateProcessResponse.ResultBean bean = datas.get(position);
