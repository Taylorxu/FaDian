...
import com.wisesignsoft.OperationManagement.net.response.QueryValidUserBydeptResponse;
...
public class WOSUAdapter2 extends RecyclerView.Adapter {
    private Context context;
    private List<QueryValidUserBydeptResponse.ReturnValueBean> datas;
    private IMultUserClickListener listener;

    public WOSUAdapter2(Context context, List<QueryValidUserBydeptResponse.ReturnValueBean> datas) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof MyHolder) {
            final QueryValidUserBydeptResponse.ReturnValueBean bean = datas.get(position);
