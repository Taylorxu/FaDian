...
public class SolvingAdapter extends RecyclerView.Adapter {
    ...
    private List<FindUnHandleProcessResponse.DataBean> datas;
    private ISolving iSolving;

    public SolvingAdapter(Context context, List<FindUnHandleProcessResponse.DataBean> datas) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyHolder) {
            final FindUnHandleProcessResponse.DataBean bean = datas.get(position);
